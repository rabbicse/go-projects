	...
	movies := []movie.Movie{
		{
			...
			Genre: []string{"Sci-Fi", "Adventure"}, Rating: 8.5,
			PosterURL:   "https://image.tmdb.org/t/p/w500/1pdfLvkbY9ohJlCjQH2CZjjYVvJ.jpg",
			Description: "Paul Atreides unites with the Fremen while on a warpath of revenge.",
			DurationMin: 166, Published: true, CreatedAt: now, UpdatedAt: now,
		...
		},
		{
			...
			Genre: []string{"Biography", "Drama", "History"}, Rating: 8.9,
			PosterURL:   "https://image.tmdb.org/t/p/w500/8Gxv8gSFCU0XGDykEGv7zR1n2ua.jpg",
			Description: "The story of J. Robert Oppenheimer's role in the development of the atomic bomb.",
			DurationMin: 180, Published: true, CreatedAt: now, UpdatedAt: now,
			Showtimes: []movie.Showtime{
		...
		},
		{
			...
			Genre: []string{"Sci-Fi", "Action", "Thriller"}, Rating: 8.8,
			PosterURL:   "https://image.tmdb.org/t/p/w500/oYuLEt3zVCKq57qu2F8dT7NIa6f.jpg",
			Description: "A thief who steals corporate secrets through dream-sharing technology.",
			DurationMin: 148, Published: true, CreatedAt: now, UpdatedAt: now,
			Showtimes: []movie.Showtime{
		...
		},
		{
			...
			Genre: []string{"Action", "Crime", "Drama"}, Rating: 7.8,
			...
			DurationMin: 176, Published: true, CreatedAt: now, UpdatedAt: now,
			Showtimes: []movie.Showtime{
		...
		},
		{
			...
			Genre: []string{"Sci-Fi", "Adventure", "Drama"}, Rating: 8.6,
			PosterURL:   "https://image.tmdb.org/t/p/w500/gEU2QniE6E77NI6lCU6MxlNBvIx.jpg",
			Description: "A team of explorers travel through a wormhole in space in an attempt to ensure humanity's survival.",
			DurationMin: 169, Published: true, CreatedAt: now, UpdatedAt: now,
			Showtimes: []movie.Showtime{
