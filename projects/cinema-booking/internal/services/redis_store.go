...
func (s *RedisStore) Book(b domain.Booking) (domain.Booking, error) {
...
func (s *RedisStore) ListBookings(movieID string) []domain.Booking {
	pattern := fmt.Sprintf("seat:%s:*", movieID)
	var sessions []domain.Booking
...
func (s *RedisStore) hold(b domain.Booking) (domain.Booking, error) {
	id := uuid.New().String()
	now := time.Now()
	ctx := context.Background()
...
func parseSession(val string) (domain.Booking, error) {
...
func (s *RedisStore) Confirm(ctx context.Context, sessionID string, userID string) (domain.Booking, error) {
...
func (s *RedisStore) getSession(ctx context.Context, sessionID string, userID string) (domain.Booking, string, error) {
